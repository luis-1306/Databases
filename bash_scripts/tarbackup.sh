...
BACKUP_DIR="/media/luis/HDD/MME_L_Luis_Acosta"
...
read opcion
   ...
   case $opcion in
	...
	sudo tar -cvzpf $BACKUP_DIR/backup.tar.gz -g /home/luis/.history/backup.snap $SOURCE;
	exit 1;;

	2)
	echo "Ejecutando backup incremental..";
	sudo tar -cvzpf $BACKUP_DIR/inc_backup.tar.gz -g /home/luis/.history/backup.snap $SOURCE;
	exit 1;;
